...
<!--	Title
	=========================================================-->
<title>CLKS Property Service</title>
</head>
<body>
<div id="page-wrapper">
    <div class="row"> 
        ...
        <!--	Banner Start   -->
        <div class="overlay-black w-100 slider-banner1 position-relative" style="background-image: url('images/banner/benner.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-lg-12">
                        <div class="text-white">
                            <h1 class="mb-4"><span class="text-success">WECLOME</span><br>
                            CLKS Property Services</h1>
                            <form method="post" action="propertygrid.php">
                                <div class="row">
                                    ...
                                    <!-- <div class="col-md-6 col-lg-2">
                                        <div class="form-group">
                                            <select class="form-control" name="type">
												...
												<option value="BoengKengKang">Boeng Keng Kang</option>
												<option value="ChamkarMon">Chamkar Mon</option>
												<option value="ChbarAmpov">Chbar Ampov</option>
												<option value="ChraoyChongvar">Chraoy Chongvar</option>
												<option value="Dangkao">Dangkao</option>
												<option value="Kamboul">Kamboul</option>
                                                <option value="MeanChey">Mean Chey</option>
                                                <option value="PraekPnov">Praek Pnov</option>
                                                <option value="PrampirMeakkakra">Prampir Meakkakra</option>
                                                <option value="PurSenchey">Pur Senchey</option>
                                                <option value="RusseyKeo">Russey Keo</option>
                                                <option value="Sensok">Sen sok</option>
                                                <option value="TuolKouk">Tuol Kouk</option>
                                            </select>
                                        </div>
                                    </div> -->
                                    <div class="col-md-6 col-lg-2">
                                    ...
                                    <div class="col-md-4 col-lg-2">
                                        <div class="form-group">
                                            <button type="submit" name="filter" class="btn btn-outline-light">Search</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                        <h2 class="text-secondary double-down-line text-center mb-5">OUR SERVICES</h2></div>
                </div>
                <div class="text-box-one">
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-5s"> 
                                    ...
                                    <div class="col-md-6 col-lg-4"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                                ...
                                                <div class="price text-primary"><b>$<?php echo $row['13'];?> </b><span class="text-white"><?php echo $row['12'];?> m2</span></div>
                                            </div>
        ...
        <!--	Achievement -->
        <div class="full-row overlay-secondary" style="background-image: url('images/phnompenh.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
            <div class="container">
                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/phnompenh/1.jpg" alt="">
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/phnompenh/2.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
									<?php
                        ...
                        <div class="col-md-6 col-lg-3 pb-1"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/phnompenh/3.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/phnompenh/4.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
