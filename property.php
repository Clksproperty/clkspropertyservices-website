    ...
    <div class="row"> 
        ...
        <div class="full-row">
            <div class="container">
                ...
                <div class="row">
                <div class="col-lg-12">
                        <h2 class="text-secondary double-down-line text-center mb-5">Recent Property</h2></div>
					<div class="col-lg-8">
                        <div class="row">
                        
							<?php 
							$query=mysqli_query($conn,"SELECT property.*, user.uname,user.utype,user.uimage FROM `property`,`user` WHERE property.uid=user.uid");
