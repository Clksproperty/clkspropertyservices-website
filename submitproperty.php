										...
										<div class="row">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="bath" required placeholder="Enter Bathroom (only no 0 to 10)">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Kitchen</label>
													<div class="col-lg-9">
														<input type="text" class="form-control" name="kitc" required placeholder="Enter Kitchen (only no 0 to 10)">
													</div>
												</div>
											...
											<div class="col-xl-6">
												<div class="form-group row mb-3">
													...
													<div class="col-lg-9">
														<select class="form-control" required name="bhk">
															...
															<option value="0 BHK">0 BHK</option>
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="bed" required placeholder="Enter Bedroom  (only no 0 to 10)">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Balcony</label>
													<div class="col-lg-9">
														<input type="text" class="form-control" name="balc" required placeholder="Enter Balcony  (only no 0 to 10)">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Hall</label>
													<div class="col-lg-9">
														<input type="text" class="form-control" name="hall" required placeholder="Enter Hall  (only no 0 to 10)">
													</div>
												</div>
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select class="form-control" required name="floor">
															...
															<option value="0st Floor">0st Floor</option>
															<option value="1nd Floor">1nd Floor</option>
															<option value="2rd Floor">2rd Floor</option>
